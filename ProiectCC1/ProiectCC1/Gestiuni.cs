...
namespace ProiectCC1
{
    public partial class Gestiuni : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'gestiuniDataSet.gestiuni' table. You can move, or remove it, as needed.
            this.gestiuniTableAdapter.Fill(this.gestiuniDataSet.gestiuni);
